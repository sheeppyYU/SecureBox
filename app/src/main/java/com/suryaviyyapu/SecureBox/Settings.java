...
public class Settings extends AppCompatActivity {
    ...
    private void secureCodeMode(boolean state) {
        ...
        if (state) {
            ...
            Toast.makeText(getApplicationContext(), "重新啟動app以應用更改", Toast.LENGTH_LONG).show();
        } else {
            //to do true
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(grantResults[0] == PackageManager.PERMISSION_GRANTED){
            ...
            Toast.makeText(getApplicationContext(), "需要權限許可", Toast.LENGTH_LONG).show();
        }
    }
                ...
                .onWorkFinishListener(new OnWorkFinishListener() {
                    ...
                    public void onFinished(boolean success, String message) {
                        ...
                        if(message.equals("success")){
                            Toast.makeText(getApplicationContext(), "重新啟動應用程序以同步您的帳號", Toast.LENGTH_SHORT).show();
                        }
                    }
                })
                .execute();
...
//                    .secretKey("your-secret-key") // if your backup file is encrypted, this parameter is required
    ...
    public void deleteData(View view) {
        ...
        alertDialogBuilder.setTitle("刪除所有帳號密碼");
        // Setting Alert Dialog Message
        alertDialogBuilder.setMessage("妳確定要刪掉全部儲存的帳號密碼?");
